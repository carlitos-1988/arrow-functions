...
console.log('no arrow functin to fix');
...
//When Joes .scope is invoked this referes to all of the properties available to joe you call also see all of the prototypes available to joe
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//This is reffering to the window object and all of the methods available to it. 
// 3. Explain why "this" is different when an arrow function is used.
// This is because they do not have their won this context field. They refer back to the static fields of a class rather than the instance of a class